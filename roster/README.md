...
The active automata of MockaSort Studio. Each entry is a constructed being with a keeper, a behavioral contract, and a portal label.
...
- **Keeper** — the org member responsible for the automaton's key and behavior
- **Invocation** — the label and which team controls access
- **Capabilities** — what kinds of tasks they handle well and what they don't
- **Contact** — how to reach the keeper if something goes wrong
